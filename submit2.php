...
// $locality = isset($_POST['locality']) ? $_POST['locality'] : '0' ;
  ...
  $sql = "select Room_capacity,Fees,H_name,Type,Curfew,Owner_name,Phone_number,Email_ID,Capacity,Total_no_of_rooms,no_of_meals,Mess_fees,Mess_capacity, locality
          ...
          and Hostel =".$_POST['hostel']." and Veg = ".$_POST['veg']." and Type = '".$_POST['type']."' and Locality = '".$_POST['locality']."';";
